$(document).ready( function() {
	...
	$('.cerrar').click(function (){
		$('#forAsigEnUs, #forAsigEncu, #formCrearZona, #formCrearConcesionario, #formBuscarConcesionario,#formBuscarZona, #subEncuesta, #subZona, #subMuestra, .forAsigEncu, #forCrearEncu, #forCrearPreg, #forSubirEncu, #forZonas, #forRegistrarUs, #forImportEncuesta').hide('scale');
	});
        
        //Funcion que aparece el menu de las Encuestas------------------------------------------------------------------>
	$('#menEncuesta').click(function (){
            $('#forSubirEncu, #forAsigEncu, #subMuestra, #forCrearPreg, #forAsigEnUs, #forRegistrarUs, #subZona, #formCrearZona, #formCrearConcesionario, #formBuscarConcesionario,#formBuscarZona, #forImportEncuesta').fadeOut('fast');
	...
	$('#asigEncu').click(function (){
         ...
         //Funcion que aparece el Formulario para la importar de las Encuestas 
	$('#impEncu').click(function (){
            $('#subEncuesta, #forCrearEncu').hide('puff');
            $('#forImportEncuesta').toggle('clip');
        });
